...
function (_React$Component) {
  ...
  function Searchbar(props) {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "handleChange", function (event, _ref) {
      var _ref$newValue = _ref.newValue,
          newValue = _ref$newValue === void 0 ? '' : _ref$newValue;
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "handleSubmit", function (event) {
      ...
      console.log('searchbar handleSubmit: ', event);
...
//# sourceMappingURL=home.js.72ee511e097208db7a17.hot-update.js.map