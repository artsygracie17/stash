...
function (_Component) {
  ...
  function Home(props) {
    ...
    _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "handleFavoritesUpdate", function (gif, isFavorite) {
      var newFavs = isFavorite ? _this.state.favorites.remove(gif) : _toConsumableArray(_this.state.favorites).concat([gif]);
...
//# sourceMappingURL=home.js.09dc053961666fd18ca9.hot-update.js.map